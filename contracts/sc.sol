...
// 2. seller participation stage: sellers participate in the evaluation stage
    function seller_participation (bytes32 _RFI_form,bytes32 _RFP_form, bytes32 _RFQ_form) public onlySeller{
...
// 4. Live auction stage: (only qualified sellers can bid)
    ...
    function sellers_bidding (uint bid) public onlySeller returns(bool) {
