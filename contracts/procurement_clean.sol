...
contract ProcurementContract{
    ...
    /////////////////////////////////
    function current_suppliers () public view returns (uint, address[]){
    ...
    /////////////////////////////////
    function current_accepted_suppliers () public view returns (uint, address[]){
        ...
        for (uint i=0; i<accepted_suppliers.length; i++){
            if (msg.sender == accepted_suppliers [i]){
                ...
                if(supplier_qualification_Bid[msg.sender].qualification_bid <= winning_qualification_bids[winning_qualification_bids.length-1] - bid_decrement){
                    ...
                    winning_qualification_suppliers.length--; // wrong?

                    winning_qualification_bids.push(supplier_qualification_Bid[msg.sender].qualification_bid);
                    winning_qualification_suppliers.push(msg.sender);   // wrong?
                }
            }
    ...
    /////////////////////////////////
    function current_qualified_suppliers () public view returns (uint[], address[]){
